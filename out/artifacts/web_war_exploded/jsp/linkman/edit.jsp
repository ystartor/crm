...
<BODY>
<s:form  id="form1" name="form1" action="linkMan_update.action" method="post" theme="simple">
			...
			<TD vAlign=top width="100%" bgColor=#ffffff>
				...
				<TABLE cellSpacing=0 cellPadding=5  border=0>
					...
					<TR>
						...
						<td>
							<s:textfield class="textbox" id="sChannel2"
										 style="WIDTH: 180px" maxLength="50" name="lk_mobile"/>
						</td>
					</TR>
					<TR>
						<td>联系人邮箱：</td>
					...
					<TR>
						...
						<td>联系人备注 ：</td>
						<td>
							<s:textarea name="lk_memo" rows="3" cols="10"/>
						</td>
					</TR>
